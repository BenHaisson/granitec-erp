...
export default function ReportsPage() {
  ...
  const bestRow = allData.reduce((best, r) => rowTotal(r) > rowTotal(best) ? r : best, allData[0] ?? { month: '', label: '', 'granite-frypan': 0, 'ceramic-frypan': 0, 'granite-saucepot': 0, 'ceramic-saucepot': 0 });
