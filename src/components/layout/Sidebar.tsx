...
import {
  ...
  BarChart3, Settings, LogOut, TrendingUp, BookOpen, Truck, AlertCircle, Building2, Users, NotebookPen,
} from 'lucide-react';
...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/unverified-stock', icon: AlertCircle, label: 'Unverified Stock' },
