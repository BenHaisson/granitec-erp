...
export const SEED_PRODUCTS: SeedProduct[] = [
  ...
  { sort_order: 8,  name: 'Marmite 26cm — Granite Black',           sku: 'JSM-1806N',    type: 'FINISHED', category: 'Marmite', unit: 'pcs', stock_level: 0, min_stock: 10, cost: 0 },
  { sort_order: 8,  name: 'Marmite 26cm — Granite Gray',            sku: 'JSM-1806G',    type: 'FINISHED', category: 'Marmite', unit: 'pcs', stock_level: 0, min_stock: 10, cost: 0 },
  { sort_order: 9,  name: 'Marmite 24cm — Granite Black',           sku: 'JSM-1805N',    type: 'FINISHED', category: 'Marmite', unit: 'pcs', stock_level: 0, min_stock: 10, cost: 0 },
  { sort_order: 9,  name: 'Marmite 24cm — Granite Gray',            sku: 'JSM-1805G',    type: 'FINISHED', category: 'Marmite', unit: 'pcs', stock_level: 0, min_stock: 10, cost: 0 },
